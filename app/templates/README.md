# <%= appname %> Plugin for [DocPad](http://docpad.org)

[![Build Status](https://secure.travis-ci.org/docpad/docpad-plugin-<%= appname %>.png?branch=master)](http://travis-ci.org/docpad/docpad-plugin-<%= appname %> "Check this project's build status on TravisCI")
[![NPM version](https://badge.fury.io/js/docpad-plugin-<%= appname %>.png)](https://npmjs.org/package/docpad-plugin-<%= appname %> "View this project on NPM")
